...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        visit_visa_product, _ = Product.objects.get_or_create(
            slug='visit-visa-insurance',
            defaults={
                'name': 'Visit Visa Travel Insurance',
                'description': 'Certified visitor visa travel insurance meeting Regulation (EC) No 810/2009 and global embassy standards with €30,000+ medical cover, zero deductible, and visa refusal refund guarantee.',
                'product_type': Product.ProductType.VISA,
            }
        )
        ...
        # 9. Travel Types
        travel_types_data = [
            {'code': 'VISIT_VISA', 'name': 'Visit / Tourist Visa', 'description': 'Embassy-compliant insurance for Schengen, UK, US, Gulf & Worldwide visitor visas', 'risk_multiplier': Decimal('1.00')},
