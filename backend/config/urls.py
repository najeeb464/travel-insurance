...
def api_root(request):
    ...
    return Response({
        ...
        'endpoints': {
            ...
            'payments_config': '/api/v1/payments/config/',
            'paypal_create_order': '/api/v1/payments/paypal/create-order/',
            'paypal_capture_order': '/api/v1/payments/paypal/capture-order/',
